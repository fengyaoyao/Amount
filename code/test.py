...
def get_downloadId(queue_config):
    ...
    try:
        ...
        requests_url = 'https://doupoclub.com/download/' + queue_config['ischeck'][0] + '?udid=' + udid
...
post_data = {
    "UDID": "",
    "appenddata": "%7B%22ChannelInfo%22%3A%22%7C%7C798%7Chttps%3A%2F%2F798-1.com%2F79l-won-cfk%2F%7C1597372246636%7C2df93ad47a7451cdabfb5f4db9d1f6c8%22%2C%22test%22%3A%22hello%22%7D",
    "device_name": "",
    "device_product": "",
    "device_version": ""
}
...
headers = {'Content-Type': 'application/xml', 'Connection': 'close'}
# 发起请求签名
response = requests.post(config['url'], data=post_data, headers=headers, proxies=proxies)